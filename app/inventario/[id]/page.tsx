              ...
              <article key={record.id} className="rounded-lg border border-zinc-800 bg-zinc-950/65 p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="text-left sm:text-right">
                    ...
                    <Link href={`/inventario/${equipment.id}/checklist-interna/${record.id}`} className="mt-3 inline-flex h-9 items-center justify-center gap-2 rounded-lg border border-zinc-800 bg-zinc-950 px-3 text-xs font-semibold text-zinc-100 transition hover:border-sky-300/60">
