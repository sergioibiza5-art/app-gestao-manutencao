...
export default async function Page({ searchParams }: DashboardPageProps) {
  ...
  const kpis = [
    ...
    { label: "Manutencoes hoje", value: String(dashboard.kpis.maintenanceToday), detail: "Agendadas para hoje", tone: "text-cyan-300" },
    { label: "Frota a vencer", value: String(dashboard.kpis.fleetDueSoon), detail: "Proximos 30 dias", tone: "text-blue-300" },
  ];
