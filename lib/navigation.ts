...
export const navigation = [
  ...
  { name: "Tarefas", href: "/tarefas", meta: "Recorrências", icon: ClipboardCheck, color: "bg-teal-400/15 text-teal-200" },
  { name: "Equipamentos", href: "/equipamentos", meta: "Cadastro e planos", icon: Settings, color: "bg-orange-400/15 text-orange-200" }, 
  { name: "Frota", href: "/frota", meta: "Veículos e quilómetros", icon: Car, color: "bg-blue-400/15 text-blue-200" },  
  { name: "Ambiental", href: "/ambiental", meta: "Temperatura e pressão", icon: Leaf, color: "bg-lime-400/15 text-lime-200" },  
  { name: "Calibração", href: "/calibracao", meta: "Certificados", icon: Gauge, color: "bg-lime-400/15 text-lime-200" },
  { name: "Localizações", href: "/localizacoes", meta: "Mapa de estantes", icon: Map, color: "bg-fuchsia-400/15 text-fuchsia-200" },
  { name: "Despesas", href: "/despesas", meta: "Faturas e recibos", icon: Receipt, color: "bg-amber-400/15 text-amber-200" },
  { name: "Análises", href: "/analises", meta: "Fornecedores e custos", icon: BarChart3, color: "bg-emerald-400/15 text-emerald-200" },
  ...
  { name: "Inventário", href: "/inventario", meta: "Peças e consumíveis", icon: Package, color: "bg-amber-400/15 text-amber-200" },
